...
for i = 1 : num_ini_condition
    ...
    % first part uses complex equations
    % second part uses polar equations
    for t = 1 : num_iterations
        [z1ans, z2ans] = Heuns_complex(z1 , z2, gamma1, gamma2);  %complex equation simulation
        z1 = z1ans;
        z2 = z2ans;
        r1_complex_vec(t) = norm(z1);
        r2_complex_vec(t) = norm(z2);

        [r1ans, r2ans, phi_ans] = Heuns_polar(r1_ini,r2_ini, phi_ini, gamma1, gamma2);    % polar equation simulation
        r1_ini = r1ans;
        r2_ini = r2ans;
...
figure(2)
plot(dt*(num_iterations1-25000:10:num_iterations1), r1_polar(end-25000:10:end), 'b-.', LineWidth=5, MarkerSize= 8);
hold on;
plot(dt*(num_iterations1-25000:10:num_iterations1), r2_polar(end-25000:10:end), 'r.', MarkerSize= 10);
...
box on
plot(dt*(num_iterations1-5000:5:num_iterations1), (phi_polar(end-5000:5:end)), 'b.', MarkerSize=4)
...
% Simulation of complex equations using Runge-Kutta Method
...
% Simulation of polar equations using Runge-Kutta Method
...
% Simulation of complex equations using Heuns Method
...
%simulation of polar equations using Heuns Method
